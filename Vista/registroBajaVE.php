...
include '../Controlador/controladorBajaVE.php';
...
<div class="bloque">
    ...
    <?php endif; ?>
    <form method="POST" name="frmbaja" id="frmbaja" action="../Controlador/controladorBajaVE.php?accion=<?php echo $proceso ? 'actualizar' : 'crear'; ?>"
        class="formulario">
  ...
  <!--Botón para cancelar y regresa al listado de baja-->
    <button type="button" onclick="window.location.href='../Vista/buscarBajaVE.php'">
       Cancelar
