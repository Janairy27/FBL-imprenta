...
include '../Controlador/controladorPedidoVE.php';
...
?>
    ...
    <div class="bloque">
        ...
        <form method="POST" name="frmpedido" id="frmpedido" action="../Controlador/controladorPedidoVE.php?accion=<?php echo $proceso ? 'actualizar' : 'crear'; ?>"
        ...
        <button type="button" onclick="window.location.href='../Vista/PedidoVE.php'">
            Cancelar
