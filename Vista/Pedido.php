    ...
    <div class="bloque">
        <h2>Listado de pedidos</h1>
            ...
            <div class="contenedor-formulario">
                <form method='POST' action="../Controlador/controladorPedido.php?accion=buscar"
                    clas="formulario">
                    ...
                    <button type="button" onclick="window.location.href='../Vista/registroPedido.php'">
                        Agregar Pedido
                        <img src="../Vista/img/mas.png" alt="Agregar" style="width: 30px; height: 30px;">
                    </button>


                    <!--Botón para ver el listado de Producto final -->
                    <button type="button" onclick="window.location.href='../Vista/ProdFinal.php'">
                        Producto final
                        <img src="../Vista/img/mas.png" alt="Agregar" style="width: 30px; height: 30px;">
                    </button>

                    <button type="button" onclick="window.location.href='../Vista/insumoproducto.php'">
                        Insumo producto
                        <img src="../Vista/img/mas.png" alt="Agregar" style="width: 30px; height: 30px;">
                    </button>

                    <!--Botón para ver el listado de Estado-->
                    <button type="button" onclick="window.location.href='../Vista/Estado.php'">
                        Estado pedido
                        <img src="../Vista/img/mas.png" alt="Agregar" style="width: 30px; height: 30px;">
                    </button>

                    <!--Botón para ver el lsitado de Detalle --->
                    ...
                    <?php if (isset($resultados) && count($resultados) > 0): ?>
                        <?php foreach ($resultados as $pedido): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../Controlador/controladorPedido.php?accion=actualizar&id=<?php echo htmlspecialchars($pedido['serie'], ENT_QUOTES, 'UTF-8'); ?>"><img src="../Vista/img/modificar.png" width="30px" height="30px"></a>
                                    <a href="../Controlador/controladorPedido.php?accion=eliminar&id=<?php echo $pedido['serie']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este pedido?');"><img src="../Vista/img/eliminar.png" width="30px" height="30px"></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
