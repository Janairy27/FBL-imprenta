    ...
    <div class="bloque">
        <h2>Listado de bajas</h1>
            ...
            <div class="contenedor-formulario">
                <form method='POST' action="../Controlador/controladorBajaVE.php?accion=buscar"
                    clas="formulario">
                    ...
                    <button type="button" onclick="window.location.href='../Vista/registroBajaVE.php'">
                        Agregar baja
                    ...
                    <?php if (isset($resultados) && count($resultados) > 0): ?>
                        <?php foreach ($resultados as $baja): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../Controlador/controladorBajaVE.php?accion=actualizar&id=<?php echo htmlspecialchars($baja['idbaja'], ENT_QUOTES, 'UTF-8'); ?>"> <img src="../Vista/img/modificar.png" width="30px" height="30px"></a>
                                    <a href="../Controlador/controladorBajaVE.php?accion=eliminar&id=<?php echo $baja['idbaja']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar esta baja?');"><img src="../Vista/img/eliminar.png" width="30px" height="30px"></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                        <?php else: ?>
        ...
        <?php endif ?>
                ...
                <!-- Botón para regresar al menu del empleado  -->
