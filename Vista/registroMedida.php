...
<body data-context="registroMedida">
    ...
    <div class="bloque">
        ...
        <h4 class="texto4">Las medidas ingresadas deben de estar en la misma unidad de medida (m, cm , mm,etc)</h4>
        <form method="POST" name="frmMedida" id="frmMedida"
            action="../Controlador/controladorMedida.php?accion=<?php echo $proceso ? 'actualizar' : 'crear'; ?>"
            class="formulario">
            ...
            <input type="text" name="largo" id="largo" placeholder="Largo"
                value="<?php echo $proceso ? $medida['largo'] : ''; ?>" onkeypress="
    ...
    ">
            ...
            <input type="text" name="ancho" id="ancho" placeholder="Ancho"
                value="<?php echo $proceso ? $medida['ancho'] : ''; ?>" onkeypress="
        // Permitir teclas numéricas (0-9) y un solo punto decimal
        var key = event.key;
        if ((key >= '0' && key <= '9') || key === '.' || event.keyCode === 8) {
            return true; // Permitir números y el punto
