...
require_once '../Controlador/controladorInsumoVE.php';
...
?>
    ...
    ?>
    <!--Vista para mostrar el listado de insumosy poder buscar, 
    ...
    <div class="bloque">
        <h2>Listado de insumos</h1>
            ...
            <div class="contenedor-formulario">
                <form method='POST' action="../Controlador/controladorInsumoVE.php?accion=buscar"
                    clas="formulario">
                    <label for="busqueda">Buscar por:</label>
                    <select name="busqueda" id="busqueda" class="opciones">
                        <option value="nomInsumo">Inusmo</option>
                    ...
                    <!-- Botón para agregar un nuevo insumo -->
                    <button type="button" onclick="window.location.href='../Vista/registroInsumoVE.php'">
                        Agregar isnumo
            ...
            <div class="table-responsive">
                    ...
                    <?php if (isset($resultados)):  ?>
                        <?php foreach ($resultados as $insumo): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../Controlador/controladorInsumoVE.php?accion=actualizar&id=<?php echo htmlspecialchars($insumo['idinsumos'], ENT_QUOTES, 'UTF-8'); ?>"> <img src="../Vista/img/modificar.png" width="30px" height="30px"></a>
                                    <a href="../Controlador/controladorInsumoVE.php?accion=eliminar&id=<?php echo $insumo['idinsumos']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este insumo?');"><img src="../Vista/img/eliminar.png" width="30px" height="30px"></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    <?php endif ?>
                ...
                <!-- Botón para regregar al menu de empleado -->
