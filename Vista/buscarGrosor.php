    ...
    <div class="bloque">
        <h2>Listado de grosores</h1>
            ...
            <div class="contenedor-formulario">
                <form method='POST' action="../Controlador/controladorGrosor.php?accion=buscar"
                    clas="formulario">
                    <label for="busqueda">Buscar por:</label>
                    <select name="busqueda" id="busqueda" class="opciones">
                        <option value="cantGrosor">Nombre</option>
                        <option value="flexibilidad">Nombre</option>
                    </select>
                    ...
                    <?php if (isset($resultados)&& count($resultados) > 0): ?>
                        <?php foreach ($resultados as $grosor): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../Controlador/controladorGrosor.php?accion=actualizar&id=<?php echo htmlspecialchars($grosor['idgrosor'], ENT_QUOTES, 'UTF-8'); ?>"><img src="../Vista/img/modificar.png" width="30px" height="30px"></a>
                                    <a href="../Controlador/controladorGrosor.php?accion=eliminar&id=<?php echo $grosor['idgrosor']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este grosor?');"><img src="../Vista/img/eliminar.png" width="30px" height="30px"></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                        <?php else: ?>
