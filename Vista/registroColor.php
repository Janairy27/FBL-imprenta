...
<?php
  ...
  $proceso = isset($color);
?>
<body data-context="registroColor">
...
<?php endif; ?>
  ...
  <!--Formulario de registro de color-->
  <div class="bloque">
    <div class="row">
      <h2>Registro de color</h2>
      <form method="POST" name="frmcolor" id="frmcolor" action="../Controlador/controladorColor.php?accion=<?php echo $proceso ? 'actualizar' : 'crear'; ?>"
        class="formulario">

        <?php if ($proceso):  ?>
          <input type="hidden" name="idcolor" value="<?php echo $color['idcolor']; ?>">
        <?php endif; ?>

        <label class="">Color: </label>
        <input type="text" name="nombre" id="nombre" placeholder="Nombre del Color"
          value="<?php echo $proceso ? $color['nomColor'] : ''; ?>" class="form-control">
    ...
    <div class="mt-3">
   <!--Botón para cancelar y regresa al listado de color-->
