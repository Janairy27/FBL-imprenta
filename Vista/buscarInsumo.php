    ...
    <div class="bloque">
        <h2>Listado de insumos</h1>
            ...
            <div class="contenedor-formulario">
                <form method='POST' action="../Controlador/controladorInsumo.php?accion=buscar"
                    clas="formulario">
                    ...
                    <?php if (isset($resultados) && count($resultados) > 0): ?>
                        <?php foreach ($resultados as $insumo): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../Controlador/controladorInsumo.php?accion=actualizar&id=<?php echo htmlspecialchars($insumo['idinsumos'], ENT_QUOTES, 'UTF-8'); ?>"> <img src="../Vista/img/modificar.png" width="30px" height="30px"></a>
                                    <a href="../Controlador/controladorInsumo.php?accion=eliminar&id=<?php echo $insumo['idinsumos']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este insumo?');"><img src="../Vista/img/eliminar.png" width="30px" height="30px"></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="20" class="text-center">No se encontraron insumos.</td>
                        </tr>
                    <?php endif ?>
                </table>
