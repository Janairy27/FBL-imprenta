...
class controladorUsuario
{
    ...
    public function validarUsuario($ide)
    {
        return $this->usuario->obtenerUsuarioID($ide);
    }
    ...
    public function procesarDatos()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isset($_POST['id']) && !empty($_POST['id'])) {
                $id = $_POST['id'];
                if ($this->validarUsuario($id)) {
                    header("Location: ../Controlador/controladorUsuario.php?accion=actualizar&id=$id&error=Usuario+existente");
                    exit;
                }
                ...
                if (empty($_POST['usuario']) || empty($_POST['contrasena']) || empty($_POST['idempleado'])) {
                    ...
                    header("Location: ../Vista/registroUsuario.php?error=" . urlencode("Usuario ya existente"));
                    exit;
                }
