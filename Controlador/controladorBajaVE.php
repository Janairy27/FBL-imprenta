...
class controladorBajaVE
{
    ...
    public function procesarBusqueda()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            include '../Vista/buscarBajaVE.php';
        }
    }
    ...
    public function procesarDatos()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($cantidad <= 0) {
                header("Location: ../Vista/registroBajaVE.php?error=La+cantidad+debe+ser+mayor+a+cero");
                exit;
            }
            ...
            header("Location: ../Vista/buscarBajaVE.php");
            exit;
        }
    }
}
    ...
    switch ($_GET['accion']) {
        ...
        case 'actualizar':
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                include '../Vista/editarBajaVE.php';
            }
            break;
        case 'eliminar':
            if (isset($_GET['id'])) {
            ...
            break;
        default:
            header("Location: ../Vista/registroBajaVE.php");
            break;
    }
}
