...
class controladorInsumoVE{
    ...
    public function crearInsumo($nomInsumo,$fechacompra,$fechauso, $cantidad,$rendimiento,
    ...
    $idtipomedida,$idmedida,$idgrosor,$idmaterial,$idproveedor,$idmarca,$idsubmaterial){
        return $this->insumo->agregarInsumo($nomInsumo, $fechacompra, $fechauso,
    $cantidad,$rendimiento,$precio,$disponibilidad,$idubicacion,$idcolor,
$idtransparencia, $idacabado, $idpresentacion, $idtipomedida, $idmedida,
$idgrosor, $idmaterial,$idproveedor,$idmarca,$idsubmaterial);
    ...
    $precio,$disponibilidad, $idubicacion, $idcolor, $idtransparencia,$idacabado,$idpresentacion,
    $idtipomedida,$idmedida,$idgrosor,$idmaterial,$idproveedor,$idmarca,$idsubmaterial){
        return $this->insumo->actualizarInsumo($id, $nomInsumo,$fechacompra,$fechauso, $cantidad,$rendimiento,
        $precio,$disponibilidad, $idubicacion, $idcolor, $idtransparencia,$idacabado,$idpresentacion,
        $idtipomedida,$idmedida,$idgrosor,$idmaterial,$idproveedor,$idmarca,$idsubmaterial);
    }
   ...
   /**Función para obtener la lsita de sbmaterial desde el controlador de submaterial */
    ...
    public function procesarBusqueda(){
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            include '../Vista/buscarInsumoVE.php';
        }
    }
    ...
    public function procesarDatos(){
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
           /* if(empty($_POST['nomInsumos']) || empty($_POST['fechacompra']) || empty($_POST['idempleado'])){
                die("Todos los campos deben estar llenos");
            }*/
            ...
            header("Location: ../Vista/buscarInsumoVE.php");
            exit;
        }
    }
}
        ...
        switch($_GET['accion']){
            ...
            case 'actualizar':               
                if($_SERVER['REQUEST_METHOD'] === 'POST'){
                    ...
                    include '../Vista/editarInsumoVE.php';
                }            
                break;
            case 'eliminar':
                if(isset($_GET['id'])){
                ...
                break;
            default:
                header("Location: ../Vista/registroInsumoVE.php");
                break;
        }
    }
