        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isset($_POST['id']) && !empty($_POST['id'])) {
                ...
                if ($this->insumo->validarInsumo(
                    ...
                    header("Location: ../Controlador/controladorInsumoVE.php?accion=actualizar&id=$id&error=Insumo+existente");
                    exit;
                }
                ...
                if ($this->insumo->validarInsumo(
                    ...
                    // Redirigir con el mensaje de error en la URL
                    header("Location: ../Vista/registroInsumoVE.php?error=Insumo+ya+existente");
                    exit;
                }
